...
function MyVideoView() {
	var self = Ti.UI.createView({
		backgroundImage:'/images/select_vb_resources.jpg'
	});
...
function loadNamesToTable(){
	...
	///
  	var selectedMembers = db2.execute("SELECT * FROM resources where category='video lesson' and memberId = '"+sudentID+"' ");
